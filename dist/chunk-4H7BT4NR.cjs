...
var _chunkXNR46HY6cjs = require('./chunk-XNR46HY6.cjs');
...
var plugin = _unplugin.createUnplugin.call(void 0, (rawOptions = {}) => {
  const options = _chunkXNR46HY6cjs.resolveOptions.call(void 0, rawOptions);
  ...
  return {
    ...
    transform(source, id) {
      return _chunkXNR46HY6cjs.transformMacros.call(void 0, {
        source,
        id,
        getRunner,
        deps,
