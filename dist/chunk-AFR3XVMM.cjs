...
var _chunkYYCZTIMBcjs = require('./chunk-YYCZTIMB.cjs');
...
var plugin = _unplugin.createUnplugin.call(void 0, (rawOptions = {}) => {
  const options = _chunkYYCZTIMBcjs.resolveOptions.call(void 0, rawOptions);
  ...
  return {
    ...
    transform(source, id) {
      return _chunkYYCZTIMBcjs.transformMacros.call(void 0, {
        source,
        id,
        getRunner,
        deps,
