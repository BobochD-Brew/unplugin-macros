...
var _chunk57WNXLCLcjs = require('./chunk-57WNXLCL.cjs');
...
var plugin = _unplugin.createUnplugin.call(void 0, (rawOptions = {}) => {
  const options = _chunk57WNXLCLcjs.resolveOptions.call(void 0, rawOptions);
  ...
  return {
    ...
    transform(source, id) {
      return _chunk57WNXLCLcjs.transformMacros.call(void 0, {
        source,
        id,
        getRunner,
        deps,
