...
var _chunkH5Q6NVZOcjs = require('./chunk-H5Q6NVZO.cjs');
...
var plugin = _unplugin.createUnplugin.call(void 0, (rawOptions = {}) => {
  const options = _chunkH5Q6NVZOcjs.resolveOptions.call(void 0, rawOptions);
  ...
  return {
    ...
    transform(source, id) {
      return _chunkH5Q6NVZOcjs.transformMacros.call(void 0, {
        source,
        id,
        getRunner,
        deps,
